...
# Use DATABASE_URL for services like Render/Netlify Neon, fallback to SQLite for local dev
...
SITE_CONFIG = {
    ...
    "SUPPORT_EMAIL": os.environ.get('SUPPORT_EMAIL') # Add your support email to .env
}
