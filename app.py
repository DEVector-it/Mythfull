...
limiter = Limiter(
    ...
    # FIX: Added 'database+' prefix to the SQLite URI for flask-limiter to recognize it.
    storage_uri=os.environ.get('LIMITER_STORAGE_URI', 'database+sqlite:///flask_limiter.db')
)
